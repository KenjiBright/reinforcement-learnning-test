...
def generate_launch_description():
    ...
    # Khởi tạo các bộ điều khiển bằng spawner (Cách này ổn định hơn ExecuteProcess)
    ...
    load_wheel_controller = Node(package="controller_manager", executable="spawner", arguments=["wheel_controller"])
