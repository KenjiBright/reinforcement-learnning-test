...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(event_handler=OnProcessExit(
            target_action=load_joint_state_broadcaster, on_exit=[load_steering_controller])),
        RegisterEventHandler(event_handler=OnProcessExit(
            target_action=load_steering_controller, on_exit=[load_wheel_controller])),
    ])
    ...
    jsb    = Node(package='controller_manager', executable='spawner',
                  arguments=['joint_state_broadcaster'])
    steer  = Node(package='controller_manager', executable='spawner',
                  arguments=['steering_controller'])
    wheel  = Node(package='controller_manager', executable='spawner',
                  arguments=['wheel_controller'])
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(OnProcessExit(target_action=steer,  on_exit=[wheel])),
    ])
